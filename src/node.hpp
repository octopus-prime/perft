...
public:
    constexpr node() noexcept
        : white("12"_r), black("78"_r), king_("e1e8"_b), rook_queen_("a1d1h1a8d8h8"_b), bishop_queen_("c1d1f1c8d8f8"_b), knight_("b1g1b8g8"_b), pawn_("27"_r), castle("a1h1a8h8"_b), en_passant(0) {}
...
//   bitboard empty = ~occupied();// | king<~side>();
  ...
  out |= bitboards::rook_queen(rook_queen<side>(), occupied());
  out |= bitboards::bishop_queen(bishop_queen<side>(), occupied());
